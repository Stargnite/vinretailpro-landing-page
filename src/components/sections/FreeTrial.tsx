...
export default function FreeTrialSection() {
  ...
  return (
    <section className="w-full">
      {/* Top banner */}
      <div className="bg-purple-700 text-white py-3 px-4 text-center text-sm md:text-base overflow-hidden whitespace-nowrap">
      ...
      <div className="card items-center justify-center bg-white py-6 px-4 md:py-6 md:px-8 max-w-4xl mx-auto mt-8 rounded-md">
        <h2 className="text-2xl md:text-3xl bg-white font-bold mb-2 text-center poppins-medium">Get our free trial today</h2>
